...
"""
function qap_ip(A::AbstractArray{<:Real,2}, B::AbstractArray{<:Real,2}; seeds::Int=0)
	n = size(A,1) - seeds
...
"""
function qap_ip_alt(A::AbstractArray{<:Real,2}, B::AbstractArray{<:Real,2}; seeds::Int=0)
	n = size(A,1) - seeds
